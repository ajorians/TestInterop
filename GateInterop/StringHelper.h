...
//
// Added to EditorInterop and modified by Brandon Thomas
// ------------------------------------------------------------------------------------------- //
#pragma once
...
namespace InteropHelper
{
   ...
   // Ignore this if you're just scanning the headers for information
   ...
   typename detail::IfManaged<SourceType>::Select::Either <
      ...
      System::String ^> ::Type marshalString(SourceType string)
   {
   ...
   {
   public:
      static std::wstring SystemStringToStdWString( System::String ^ text )
      {
         msclr::interop::marshal_context context;
         return context.marshal_as<std::wstring>( text );
      }

      static std::string SystemStringToStdString( System::String ^ text )
      {
         return marshalString<E_UTF8>( text );
      }

      static System::String^ StdStringToSystemString( const std::string & s )
      {
         return marshalString<E_UTF8>( s );
      }

      static System::String^ StdWStringToSystemString( const std::wstring & ws )
      {
         msclr::interop::marshal_context context;
         return context.marshal_as<System::String^>( ws );
      }
   };
